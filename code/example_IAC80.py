...
astro = Astrometry(r'C:\Users\wao\Desktop\NEO_pipeline\test_series\20260603', 
                   r"/mnt/c\Users\wao\Desktop\NEO_pipeline\test_series\20260603")
...
astro.get_solutions(xyls=True, sigma=5, fwhm=5, make_plots=False, use_existing=True, degree=1)
...
positions_g, positions_m = astro.track_objects(make_plots=True, threshold=10, fwhm=5, stationary_error=1*u.arcsec, prediction_error=3*u.arcsec, depth=4, rejection=True)
