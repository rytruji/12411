...
astro.get_solutions(xyls=True, sigma=5, fwhm=5, make_plots=True, use_existing=False, degree=1)
...
positions_g, positions_m = astro.track_objects(make_plots=False, threshold=3, fwhm=3, stationary_error=0.5*u.arcsec, prediction_error=5*u.arcsec, depth=5, rejection=True)
